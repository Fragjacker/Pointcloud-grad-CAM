...
def pyplot_draw_point_cloud_nat_and_adv(points, points_adv, output_filename):
    ...
    plt.axis('off')
    plt.savefig(output_filename+'_1nat_x.png')
    plt.close()
    ...
    ax.set_zlim(xmin, xmax)
    plt.axis('off')
    plt.savefig(output_filename+'_2adv_x.png')
    plt.close()
    ...
    plt.axis('off')
    plt.savefig(output_filename+'_3nat_y.png')
    plt.close()
    ...
    ax.set_zlim(ymin, ymax)
    plt.axis('off')
    plt.savefig(output_filename+'_4adv_y.png')
    plt.close()
    ...
    plt.axis('off')
    plt.savefig(output_filename+'_5nat_z.png')
    plt.close()
    ...
    ax.set_zlim(zmin, zmax)
    plt.axis('off')
    plt.savefig(output_filename+'_6adv_z.png')
    plt.close()
...
def plot_nat_interval_adv(points, drop_points, image_filename):
    ...
    ax.set_zlim(ymin, ymax)
    plt.axis('off')
    plt.savefig(image_filename+'_y1.png', bbox_inches='tight')
    plt.close()
    ...
    ax.set_zlim(ymin, ymax)
    plt.axis('off')
    plt.savefig(image_filename+'_y2.png', bbox_inches='tight')
    plt.close()
    ...
    ax.set_zlim(ymin, ymax)
    plt.axis('off')
    plt.savefig(image_filename+'_y3.png', bbox_inches='tight')
    plt.close()
