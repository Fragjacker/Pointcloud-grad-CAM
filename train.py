...
def getOps(pointclouds_pl, labels_pl, is_training_pl, batch, pred, maxpool_out, feature_vec, loss, train_op, merged):
...
def train():
    with tf.Graph().as_default():
        with tf.device('/gpu:' + str(GPU_INDEX)):
            ...
            # Get model and loss 
            pred, end_points, maxpool_out, feature_vec = MODEL.get_model(pointclouds_pl, is_training_pl,
                                                                         bn_decay=bn_decay)
        ...
        modelpath = os.path.join(LOG_DIR, "model.ckpt")
        if usePreviousSession and os.path.exists(modelpath):
            trained_model = modelpath
            saver.restore(sess, trained_model)
            print("Model restored.")

        # --Get proper Ops.
        ops = getOps(pointclouds_pl, labels_pl, is_training_pl, batch, pred, maxpool_out, feature_vec, loss, train_op,
                     merged)
